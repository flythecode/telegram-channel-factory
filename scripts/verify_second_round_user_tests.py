...
PACKET_DIR = ROOT / "controlled-user-tests" / "round-2-2026-03-14"
...
def is_filled(path: Path, template_hash: str) -> bool:
    ...
    return "- Date:" in text and "- Participant:" in text and "## Summary" in text and "TBD" not in text
...
def main() -> int:
    ...
    print(json.dumps({"verifiedAt": now, "filledParticipantFiles": filled_count, "status": manifest["currentStatus"]}, ensure_ascii=False))
    return 0
