...
def human_mode_label(mode: str) -> str:
    ...
    return {
        'manual': 'Ручной — каждое важное действие подтверждаешь ты',
        'semi_auto': 'Ассистент — бот ведёт очередь и расписание, но ключевые решения остаются за тобой',
        'auto': 'Авто — максимум автоматизации без ручного подтверждения каждого шага',
