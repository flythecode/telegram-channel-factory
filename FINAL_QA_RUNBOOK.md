...
Перед переходом к релизу результат нужно не просто «помнить», а перенести в конкретный файл `release_records/YYYY-MM-DD-<release-marker>.md`.

Туда полезно зафиксировать:
